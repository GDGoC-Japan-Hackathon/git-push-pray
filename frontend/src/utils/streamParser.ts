 ...
 */
export function extractJSONStringField(partialJSON: string, field: string): string | null {
...
async function processSSEBlock(block: string, onEvent: (event: string, data: string) => void | Promise<void>) {
...
async function parseSSEText(text: string, onEvent: (event: string, data: string) => void | Promise<void>) {
