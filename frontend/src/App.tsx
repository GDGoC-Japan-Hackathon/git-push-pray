          ...
          prev.map((s) =>
            s.id === sessionId
              ? {
                  ...
                  lastMessage:
                    partial.slice(0, 60) + (partial.length > 60 ? "..." : ""),
                }
              : s
          )
        );
    ...
    async (text: string) => {
      ...
      try {
        ...
        const fallbackResponse =
          "申し訳ありません。バックエンドへの接続に失敗しました。ローカルでGoサーバーが起動しているか確認してください。";
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden bg-gray-50 justify-center">
          <div className="flex h-full w-full max-w-5xl">
            <div className="hidden sm:flex w-92 flex-shrink-0 bg-white border-r border-gray-200">
              <AvatarCanvas
                url="/avatar.vrm"
            ...
            <div className="flex flex-col flex-1 min-w-0 bg-white shadow-sm overflow-hidden">
              <ChatArea
